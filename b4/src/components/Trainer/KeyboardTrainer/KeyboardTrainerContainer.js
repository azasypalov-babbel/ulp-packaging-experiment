...
import { removeGapFormatting } from '@lessonnine/babbel-markup-helper.js';
...
import KeyboardTrainer from '../../Trainer/KeyboardTrainer/KeyboardTrainer';
...
export const KeyboardTrainerContainer = ({
  attemptItem,
  completeItem,
  ...
  return (
    ...
    >
      <KeyboardTrainer
        ...
        targetCharacter={removeGapFormatting(items[0].learnLanguageText)}
...
KeyboardTrainerContainer.propTypes = {
